        ...
        <section className="section section--tinted">
          <div className="container text-center">
            ...
            <div className="why-grid">
              {[
                { num: '☕', title: 'Coffee Bar', desc: 'Start your visit with a fresh cup. We believe comfort begins the moment you walk in the door.' },
                { num: '💆', title: 'Massage Chairs', desc: 'Our waiting area features massage chairs so you can relax before your appointment — not dread it.' },
                { num: '🎁', title: 'Welcome Gifts', desc: 'New patients receive a welcome gift bag as a small thank-you for trusting us with your smile.' },
                { num: '🛡', title: 'Honest Care', desc: 'We recommend only what you need. No upselling, no pressure, no vague treatment plans.' },
                { num: '👪', title: 'Family-Friendly', desc: 'Kids and adults both feel at home here. We&apos;re a true family practice.' },
                { num: '💉', title: 'Sedation Available', desc: 'Nitrous oxide and oral conscious sedation for patients who want a more relaxed experience.' },
              ].map(w => (
