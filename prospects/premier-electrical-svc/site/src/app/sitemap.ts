...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${SITE_URL}/services/hot-tub-spa-wiring`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${SITE_URL}/services/outbuilding-adu-wiring`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    ...
    { url: `${SITE_URL}/service-area/mount-vernon`, lastModified: now, changeFrequency: 'monthly', priority: 0.9 },
    { url: `${SITE_URL}/service-area/anacortes`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/service-area/burlington`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/service-area/bellingham`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${SITE_URL}/service-area/sedro-woolley`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
