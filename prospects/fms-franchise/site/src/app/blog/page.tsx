...
const BLOG_POSTS = [
  { title: 'Franchise Discovery Day Guide for Franchisors', category: 'Franchise Development', date: 'March 2026', slug: 'franchise-discovery-day-guide-for-franchisors', readTime: '10 min read', excerpt: 'You can generate all leads, host calls, and send all the documents you want — but that decision often comes down to one pivotal moment: the franchise discovery day. Here is how to design one that converts.' },
  { title: 'How to Franchise Your Business in Europe Successfully', category: 'International', date: 'March 2026', slug: 'how-to-franchise-your-business-in-europe-successfully', readTime: '11 min read', excerpt: 'When planned properly, choosing to franchise your business in Europe can be one of the most strategic moves you ever make — allowing you to scale without the capital burden of company-owned expansion.' },
  { title: 'Franchise Territory Mapping Best Practices for 2025', category: 'Strategy', date: 'February 2026', slug: 'franchise-territory-mapping-best-practices-for-2025', readTime: '9 min read', excerpt: 'Territory mapping is precisely what keeps the system balanced — it shapes how fast a brand can grow, where it can expand, and how franchisees will operate day to day. Here are the best practices for 2025.' },
  { title: 'Franchisee Onboarding Process Guide for Growing Franchisors', category: 'Operations', date: 'February 2026', slug: 'franchisee-onboarding-process-guide-for-growing-franchisors', readTime: '9 min read', excerpt: 'When a franchise agreement is signed, most new franchisees feel two emotions at once: excitement and uncertainty. A structured onboarding process bridges that gap.' },
  { title: 'Franchise Registration Requirements Explained', category: 'Legal', date: 'January 2026', slug: 'franchise-registration-requirements-explained', readTime: '8 min read', excerpt: 'Franchise registration requirements are rarely explained clearly, and most founders only hear about them after something goes wrong. Here is everything you need to know before selling franchises.' },
  { title: 'Top 10 Franchises in the World and What They Do Differently', category: 'Strategy', date: 'January 2026', slug: 'top-10-franchises-in-the-world-and-what-they-do-differently', readTime: '8 min read', excerpt: 'Most business owners admire the top 10 franchises from a distance, assuming they operate on a completely different level. The truth is simpler — and what they do differently can apply to your concept.' },
  { title: 'How to Franchise Your Business: The Complete Guide', category: 'Franchise Development', date: 'March 2025', slug: 'how-to-franchise-your-business-2025', readTime: '12 min read', excerpt: 'The complete A-Z roadmap for converting a successful business into a scalable franchise system — from feasibility study through your first franchisee closing.' },
