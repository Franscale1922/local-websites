    ...
    <>
          ...
          <div className="hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div>
              ...
              <p style={{ textAlign: 'center', marginTop: '0.75rem', fontSize: '0.82rem', color: 'rgba(255,255,255,0.45)' }}>
                "How to Franchise Your Business" — Chris Conner, President of FMS
              </p>
            </div>
      ...
      <section style={{ background: '#fff', padding: '4.5rem 0' }}>
        <div className="container">
          <div style={{ maxWidth: '760px', margin: '0 auto', textAlign: 'center', marginBottom: '3rem' }}>
          ...
          <div className="trigger-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.5rem', marginBottom: '3rem' }}>
            {TRIGGERS.map(t => (
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="grid-3" style={{ marginTop: '2.5rem' }}>
            {SERVICES.map((s, idx) => (
              <Link href={s.href} key={s.title} style={{
                display: 'block', background: '#fff', borderRadius: '16px',
                padding: '2rem', border: '1.5px solid #e2e8f0', transition: 'all 0.3s', textDecoration: 'none',
              }}>
      ...
      <section className="section section-alt">
        <div className="container">
          ...
          <div className="grid-3" style={{ marginTop: '2.5rem' }}>
            {CASE_STUDIES.map(cs => (
              <Link href={cs.href} key={cs.title} className="card" style={{ display: 'block' }}>
      ...
      <section className="section section-alt">
        <div className="container">
          ...
          <div className="industries-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '1rem', marginTop: '2rem' }}>
            {INDUSTRIES.map(ind => (
