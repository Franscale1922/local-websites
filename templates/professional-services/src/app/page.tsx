...
const SITE = {
  ...
  heroH1: 'A Dentist You Actually Look Forward to Seeing.',
  heroSub: "We know that's a low bar in this industry. We cleared it anyway. Modern care, friendly team, same-day appointments most weeks.",
  ...
  aboutTitle: 'We Built This Practice on Referrals.',
  aboutP1: "Our first patients came from word of mouth. Eighteen years later, most of our new patients still come the same way. We're proud of that.",
  aboutP2: "Dr. [Name] grew up in Kalispell and came back here to practice after dental school in Seattle. This community is home. That matters in how we treat everyone who comes through the door.",
  ...
  phone: '(406) 555-0300',
  email: 'hello@fvdental.com',
  address: '789 Center St, Kalispell, MT 59901',
  footerTagline: 'Family dental care in Kalispell, MT. Accepting new patients.',
